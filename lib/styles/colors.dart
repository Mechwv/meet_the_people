...
const Color defaultAppColor = Color(0xFFBBDEFB); //Color(0xFF77C5C1);
const Color test = Color(0x006FFD); //Color(0xFF77C5C1);
...
const Color defaultAppColor4 =  Color(0xFF006FFD); //Color(0xFF4a707a);
